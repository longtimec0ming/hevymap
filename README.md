...
- **History** — trend lines and week-over-week comparisons, with the 32 sub-muscles grouped under their 7 coarse regions; hover a sub-muscle's trend card for a link to its pre-filtered view on Exercises.
